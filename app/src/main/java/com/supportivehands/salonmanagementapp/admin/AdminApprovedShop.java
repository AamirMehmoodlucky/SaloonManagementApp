...
public class AdminApprovedShop extends AppCompatActivity implements ShopInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_approved_shop);
        ...
        list=new ArrayList<>();
        adapter=new AdptrPendingShop(AdminApprovedShop.this,list,"Approved",this);
        recyclerView.setAdapter(adapter);
        showLoadingDialog(AdminApprovedShop.this,"onCreatePendingShopAdmin");
        dbRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot datasnapshot:snapshot.getChildren()){
                    UserProvider userProvider=datasnapshot.getValue(UserProvider.class);
                    if (userProvider.getStatus().equals("Approved")){
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(AdminApprovedShop.this, "Error"+error.getMessage(), Toast.LENGTH_SHORT).show();
                hideDialog();
    ...
    @Override
    public void reomveAndUpdate(String UID, int pos, String statusNew, Context ctx) {
        showAlertDiag( UID, pos, statusNew, ctx);
                    ...
                    public void onClick(DialogInterface arg0,
                        ...
                        dbref.child(UID).updateChildren(hashMap).addOnSuccessListener(new OnSuccessListener() {
                            ...
                            public void onSuccess(Object o) {
                                ...
                                Toast.makeText(AdminApprovedShop.this, "Pending Done Successfully", Toast.LENGTH_SHORT).show();
                            }
                        }).addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(AdminApprovedShop.this, "Error:"+e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
...
//        this.finish();
//        startActivity(new Intent(AdminApprovedShop.this,AdminDashbrd.class));
//        super.onBackPressed();
//    }
}